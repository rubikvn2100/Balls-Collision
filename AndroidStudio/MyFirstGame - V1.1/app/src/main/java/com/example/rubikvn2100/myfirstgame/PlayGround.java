...
public class PlayGround
{
    ...
    private void ballsCollision( Ball A, Ball B )
    {
        ...
        Vector unit_i = i.getUnitVector();
        Vector unit_j = unit_i.getRotate90();

        double A_vi = Vector.dot( unit_i, A.getVelocity() );
        double A_vj = Vector.dot( unit_j, A.getVelocity() );

        double B_vi = Vector.dot( unit_i, B.getVelocity() );
        double B_vj = Vector.dot( unit_j, B.getVelocity() );
        ...
        A.setVx( A_new_vi * unit_i.getX() + A_vj * unit_j.getX() );
